<?php
session_start();
require_once 'exploreClass.php';

$explore = new Explore();
$trendingPosts = $explore->getTrendingPostsByLikes();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="row text-white text-center g-1">
        ...
        $explore = new Explore();
        $trendingPosts = $explore->getTrendingPostsByLikes(); // Fetch trending posts by likes
        ?>
            ...
            <?php foreach ($trendingPosts as $post): ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mt-1">
                    <div class="img_container">
                        <!-- Wrap the image with a link to post.php -->
        ...
        <?php else: ?>
            <div class="col-12">
                <p class="text-muted">No trending posts to display.</p>
            </div>
        <?php endif; ?>
    </div>
