...
if (!isset($_SESSION['user_id'])) {
    header('Location: main.php'); // Redirect to login if user is not logged in
    exit();
}
...
// Fetch user data
$user = $users->getUserById($_SESSION['user_id']); // Add this function in Users class
if (!$user) {
...
// Fetch user posts
$userPosts = $posts->getPostsByUserId($_SESSION['user_id']); // Add this function in Posts class
        ...
        <div class="row justify-content-center align-items-center d-flex">
            <div class="col-5 col-sm-4 col-lg-3">
                <div class="acc_avatar border mb-5 position-relative">
                    ...
                    <!-- Hidden File Input -->
                    <form action="update_avatar.php" method="POST" enctype="multipart/form-data" id="avatarForm">
            ...
            <div class="col-7 col-sm-8 col-lg-9">
               ...
               <div class="row text-white text-start g-1 acc_top">
                 <div class="links justify-content-start d-flex fs-5 mb-3  border-bottom">
                   <a href="likedPage.php" class="links_acc text-dark mb-3 text-start link-underline link-underline-opacity-0">Liked</a>
                  </div>
